                    ...
                    <div id="collapseOne" class="accordion-body collapse">
                        <div class="accordion-inner">
                            <form style="margin-bottom:12px;" id="signupForm" method="POST">
                                <input type="hidden" name="signupToken" id="signupToken" value="206315271453ca0df99f5349.49170556"/>
...
<p class="error">
	<strong>Error: </strong>
	The requested address <strong>'/assets/js/respond.min.js'</strong> was not found on this server.</p>
