                    ...
                    <div id="collapseOne" class="accordion-body collapse">
                        <div class="accordion-inner">
                            <form style="margin-bottom:12px;" id="signupForm" method="POST">
                                <input type="hidden" name="signupToken" id="signupToken" value="111933647253ca0df0bae6a4.05970431"/>
...
<p class="error">
	<strong>Error: </strong>
	The requested address <strong>'/assets/js/html5shiv.js'</strong> was not found on this server.</p>
